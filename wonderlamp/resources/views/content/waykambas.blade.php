...
@section('carosel')
<div class="img">
    <img src="https://www.batiqa.com/upload/news/l/whatsapp-image-2019-10-31-at-22448-pm_1uwj7.jpeg" alt="" srcset="">
</div>
@endsection

@section('detail')
<div class="description">
    Taman Nasional Way Kambas adalah <span id="dots">...</span>
