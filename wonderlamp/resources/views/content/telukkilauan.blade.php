@extends('content.contentmain')

@section('title')
<title>Teluk Kilauan</title>
@endsection

@section('carosel')
<div class="img">
    <img src="http://piknikasik.com/wp-content/uploads/2016/08/pemandangan-teluk-kiluan-lampung5.jpg" alt="" srcset="">
</div>
@endsection

@section('detail')
<div class="description">
    Teluk Kilauan adalah <span id="dots">...</span>
